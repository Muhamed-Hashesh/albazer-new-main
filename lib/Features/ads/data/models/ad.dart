  ...
  factory Ad.fromJson(Map<String, dynamic> json) {
    ...
    return Ad(
      ...
      additionalFeatures: json['additional features'] != null
          ...
          : null,
      numberOfRooms: num.tryParse(json['number of rooms']?.toString() ?? ''),
      numberOfSalons:
          num.tryParse(json['number of livingRooms']?.toString() ?? ''),
      numberOfBathrooms:
          num.tryParse(json['number of bathrooms']?.toString() ?? ''),
      year: json['year'],
      count1: num.tryParse(json['count1']?.toString() ?? ''),
      count2: num.tryParse(json['count2']?.toString() ?? ''),
      count3: num.tryParse(json['count3']?.toString() ?? ''),
      count4: num.tryParse(json['count4']?.toString() ?? ''),
      count5: num.tryParse(json['count5']?.toString() ?? ''),
      securityDeposit: num.tryParse(json['security deposit']?.toString() ?? ''),
      ratingAverage: num.tryParse(json['rating average']?.toString() ?? ''),
      ratingQuantity: num.tryParse(json['rating quantity']?.toString() ?? ''),
